  ...
  Page: {
    ...
    stat: function (a) {
      if ("" != MTA_CONFIG.app_id) {
        ...
        for (var d = a.length; c < d; c++) for (var f in a[c]) a[c].hasOwnProperty(f) && b.push(f + "=" + ("undefined" == typeof a[c][f] ? "" : a[c][f]));
  ...
  Event: {
    stat: function (a, b) {
      if ("" != MTA_CONFIG.event_id) {
        ...
        for (f = d.length; e < f; e++) for (var h in d[e]) d[e].hasOwnProperty(h) && c.push(h + "=" + ("undefined" == typeof d[e][h] ? "" : d[e][h]));
